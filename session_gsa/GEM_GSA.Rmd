...
knitr::opts_knit$set(root.dir="~/github/workshop_omics_integration/session_gsa/lab")
...
setwd("~/github/workshop_omics_integration/session_gsa/lab")
```
...
if (!dir.exists(tcga_dir)) { dir.create(tcga_dir, recursive = TRUE) }
```
